 ...
 * @author Maycon Silva
 */
public class FrmConsultaAmigo extends javax.swing.JDialog {
    
    ConectaBanco conn = new ConectaBanco();
    private String idCodigo, nomeAmigo,telefone,local;
     ...
     */
    public FrmConsultaAmigo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTableColecaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableColecaoMouseClicked
        ...
        nomeAmigo = (jTableColecao.getValueAt(linha_selecionada, 1).toString());
        telefone = (jTableColecao.getValueAt(linha_selecionada, 2).toString());
        local = (jTableColecao.getValueAt(linha_selecionada, 3).toString());
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
       ...
       if(jComboBoxTipoPesquisa.getSelectedItem().equals("TODOS")){           
           preencherTabelaColecao("select *from tblAmigo");
       }else if(jComboBoxTipoPesquisa.getSelectedItem().equals("NOME")){
           String filtro = jTextFieldFiltroPesquisa.getText().toString();
           preencherTabelaColecao("select *from tblAmigo where nome_tblAmigo = '"+filtro+"'"); 
       }else if(jComboBoxTipoPesquisa.getSelectedItem().equals("CÓDIGO")){
           String filtro = jTextFieldFiltroPesquisa.getText().toString();
           preencherTabelaColecao("select *from tblColecao where id_tblAmigo = '"+filtro+"'"); 
       }
   ...
   public void preencherTabelaColecao(String sql){
        ...
        String[] Colunas = new String[]{"ID","NOME","TELEFONE","LOCAL"};
        conn.conexao();
        conn.executaSQL(sql);
        try{
            conn.rs.next();
            do{
                dados.add(new Object[]{ conn.rs.getString("id_tblAmigo") ,conn.rs.getString("nome_tblAmigo"),conn.rs.getString("telefone_tblAmigo"),conn.rs.getString("localAmigo_tblAmigo")});
        ...
        jTableColecao.getColumnModel().getColumn(1).setPreferredWidth(150);
        jTableColecao.getColumnModel().getColumn(1).setResizable(false);
        jTableColecao.getColumnModel().getColumn(2).setPreferredWidth(120);
        jTableColecao.getColumnModel().getColumn(2).setResizable(false);
        jTableColecao.getColumnModel().getColumn(3).setPreferredWidth(220);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaAmigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsultaAmigo dialog = new FrmConsultaAmigo(new javax.swing.JFrame(), true);
