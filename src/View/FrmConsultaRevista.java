 ...
 * @author Maycon Silva
 */
public class FrmConsultaRevista extends javax.swing.JDialog {
     ...
     */
    public FrmConsultaRevista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTableColecaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableColecaoMouseClicked
        ...
        anoRevista = (jTableColecao.getValueAt(linha_selecionada, 1).toString());
        ...
        jTextFieldColecaoClicada.setText(anoRevista);
   ...
   public void preencherTabelaColecao(String sql){
        ...
        jTableColecao.getColumnModel().getColumn(1).setPreferredWidth(120);
        jTableColecao.getColumnModel().getColumn(1).setResizable(false);
        jTableColecao.getColumnModel().getColumn(2).setPreferredWidth(180);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaRevista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsultaRevista dialog = new FrmConsultaRevista(new javax.swing.JFrame(), true);
    ...
    /**
     * @param anoRevista the anoRevista to set
     */
    ...
    /**
     * @return the caixaRevista
     */
    public String getCaixaRevista() {
        return caixaRevista;
    }

    /**
     * @param caixaRevista the caixaRevista to set
     */
    public void setCaixaRevista(String caixaRevista) {
